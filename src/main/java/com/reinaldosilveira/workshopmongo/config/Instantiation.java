package com.reinaldosilveira.workshopmongo.config;
...
import com.reinaldosilveira.workshopmongo.dto.AuthorDTO;
import com.reinaldosilveira.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia!", "Acordei feilz hoje!", new AuthorDTO(maria));
